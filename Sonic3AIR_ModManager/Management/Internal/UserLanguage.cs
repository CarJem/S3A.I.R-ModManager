...
namespace Sonic3AIR_ModManager.Management
{
    public class UserLanguage
    {
        ...
        {
            string currentLang = Management.MainDataModel.Settings.UserLanguage;
        ...
        {
            Management.MainDataModel.Settings.UserLanguage = GetLangString(value);
        ...
        {
            Management.UserLanguage.ApplyLanguage(ref form.ModViewer);
            ...
            form.saveMenuItem.Header = Program.LanguageResource.GetString("Save");
            form.LoadMenuItem.Header = Program.LanguageResource.GetString("Save&Load");
            form.forceKillMenuItem.Header = Program.LanguageResource.GetString("ForceQuitGame");
            #endregion
            ...
            form.ModCollectionsMenuItem.Content = Program.LanguageResource.GetString("ModCollectionsMenuItem");
            ...
            form.SetAIRPathButton.Content = GetOutputString("ChangeAIRVersion");
            ...
            form.selectVersionButton.Content = Program.LanguageResource.GetString("Select_Button");
            ...
            Management.MainDataModel.SetTooltips(ref form);
        }
