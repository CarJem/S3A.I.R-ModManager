...
namespace Sonic3AIR_ModManager.Management
{
    public static class ProgramPaths
    {
        ...
        {
            return Management.MainDataModel.Settings.Sonic3AIRPath;

        }
        public static string GetSonic3AIRBaseFolderPath()
        {
            if (File.Exists(Management.MainDataModel.Settings.Sonic3AIRPath))
            {
                return Path.GetDirectoryName(Management.ProgramPaths.Sonic3AIRPath);
            }
            else return "";
        ...
        {
            Management.MainDataModel.Settings.Sonic3AIRPath = value;
        ...
        {
            string message = Management.UserLanguage.AIRPathNotSet(text);
            System.Windows.Forms.MessageBox.Show(message);
        }

        private static void FileDoesNotExistMessageBox(string text)
        {
            string message = Management.UserLanguage.FileDoesNotExist(text);
            System.Windows.Forms.MessageBox.Show(message);
        }
        ...
        {
            if (Management.UserLanguage.GetOutputString("UnsetFolderPathString") == null)
            {
                return "UNSET_FOLDER_PATH";
            }
            else return Management.UserLanguage.GetOutputString("UnsetFolderPathString");
        }
        ...
        public static void SetCustomGameRecordingsFolderPath()
        {
            ...
            {
                Title = Management.UserLanguage.GetOutputString("SetCustomGameRecordingFolderTitle")
            };
        ...
        private static bool DoesDefaultGameRecordingsFolderPathExist()
        {
            ...
            {
                if (Management.MainDataModel.S3AIRSettings.Version >= new Version("19.12.7.0"))
                {
                    return Directory.Exists(Path.Combine(Sonic3AIRAppDataFolder, "gamerecordings"));
                }
                else
            ...
            {
                return File.Exists(Management.ProgramPaths.Sonic3AIRPath);
            }
        }
